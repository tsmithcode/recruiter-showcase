...
// Default catalog using the new Item model
const defaultCatalog: Item[] = [
  {
    id: "snippet",
    title: "Code Snippet",
    description: "Battle-tested snippet ready to drop-in to any TypeScript project.",
    unit: "per snippet",
    price: 10,
    qty: 1,
    mandatory: true,
    icon: "FaCode",
    productUrl: "https://github.com/tsmithcode/snippet",
    stripeUrl: "https://buy.stripe.com/test_snippet",
    thumb: "/thumbs/snippet.png",
    tags: ["code", "typescript", "utility"],
  },
  {
    id: "readme",
    title: "README Instructions",
    description: "Markdown setup & usage guide for rapid onboarding.",
    unit: "per document",
    price: 15,
    qty: 1,
    mandatory: true,
    icon: "FaFileAlt",
    productUrl: "https://github.com/tsmithcode/readme",
    stripeUrl: "https://buy.stripe.com/test_readme",
  ...
  },
  {
    ...
    description: "Step-by-step PDF walk-through with screenshots.",
    unit: "per guide",
    price: 20,
    qty: 1,
    mandatory: true,
    icon: "FaFilePdf",
    productUrl: "https://github.com/tsmithcode/pdf-guide",
    stripeUrl: "https://buy.stripe.com/test_guide",
    thumb: "/thumbs/guide.png",
    tags: ["docs", "pdf"],
  },
  {
    id: "productImage",
    title: "Product Image",
    description: "High-res transparent PNG for marketing or documentation.",
    unit: "per image",
    price: 0,
    qty: 1,
    mandatory: false,
    icon: "FaImage",
    productUrl: "/assets/images/product.png",
    thumb: "/thumbs/productImage.png",
    tags: ["asset", "image"],
  },
  {
    id: "previewVideo",
    title: "Preview Video",
    description: "90-second overview—perfect for demos & stakeholder buy-in.",
    unit: "per video",
    price: 0,
    qty: 1,
    mandatory: false,
    ...
    thumb: "/thumbs/previewVideo.png",
    tags: ["video", "demo"],
  },
  {
    id: "repo",
    title: "7-Day Repo Access",
    description: "Temporary GitHub access for due-diligence code review.",
    unit: "access",
    price: 25,
    qty: 1,
    mandatory: false,
    icon: "FaGithub",
    productUrl: "https://github.com/tsmithcode/recruiter-showcase",
    stripeUrl: "https://buy.stripe.com/test_repo",
    tags: ["repo", "access"],
  },
  {
    id: "productDesc",
    title: "Product Description",
    description: "SEO-optimized product description copy.",
    unit: "per product",
    price: 0,
    qty: 1,
    mandatory: false,
    icon: "FaInfoCircle",
    tags: ["copywriting", "description"],
  },
  {
    id: "sampleData",
    title: "Sample Data Set",
    description: "JSON & CSV samples for rapid POC integration tests.",
    unit: "per dataset",
    price: 5,
    qty: 0,
    mandatory: false,
    icon: "FaDatabase",
    productUrl: "/data/sample.json",
    tags: ["data", "sample"],
  },
  {
    id: "troubleshoot",
    title: "Troubleshooting Guide",
    description: "FAQ + fix scripts for common edge-cases.",
    unit: "per guide",
    price: 10,
    qty: 0,
    mandatory: false,
    icon: "FaTools",
    stripeUrl: "https://buy.stripe.com/test_troubleshoot",
    tags: ["support", "guide"],
  },
  {
    id: "caseStudy",
    title: "Case Study",
    description: "Real-world ROI story with metrics & screenshots.",
    unit: "per document",
    price: 20,
    qty: 0,
    mandatory: false,
  ...
  },
  {
    id: "faq",
    title: "FAQ Document",
    description: "Common questions & answers for quick self-service.",
    unit: "per document",
    price: 0,
    qty: 0,
    mandatory: false,
  ...
  },
  {
    ...
    description: "Verified quote highlighting ROI achieved with this code.",
    unit: "per quote",
    price: 0,
    qty: 0,
    mandatory: false,
