...
const docLinks = [
  { icon: <SiDotnet />, label: '.NET', href: 'https://learn.microsoft.com/en-us/dotnet/' },
  {
    icon: <SiBlazor />,
    label: 'Blazor',
    href: 'https://learn.microsoft.com/en-us/aspnet/core/blazor/',
  },
  ...
  { icon: <FaBootstrap />, label: 'Bootstrap', href: 'https://getbootstrap.com/docs/' },
  {
    icon: <SiAutodesk />,
    label: 'Inventor API',
    href: 'https://help.autodesk.com/view/INVNTOR/2024/ENU/?guid=UserManualIndex',
  },
    ...
    <section className="py-6 px-4 max-w-7xl mx-auto container">
      ...
      >
        {docLinks.map(
          (
            { icon, label, href },
            idx // Added idx for staggered item animation
          ) => (
            ...
            >
              <Link href={href} target="_blank" className="hover:text-white transition">
                {icon}
              </Link>
            </motion.span>
          )
